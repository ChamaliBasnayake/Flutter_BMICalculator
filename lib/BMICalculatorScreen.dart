...
import 'package:flutterapp/ResultScreen.dart';
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text("Height in cm", style: TextStyle(color: Colors.grey, fontSize: 24, fontWeight: FontWeight.w400),),
              ...
              Text("$_heightOfUser cm", style: TextStyle(color: Colors.red, fontSize: 18, fontWeight: FontWeight.w400),),
              SizedBox(height: 24,),

              Text("Weight in kg", style: TextStyle(color: Colors.grey, fontSize: 24, fontWeight: FontWeight.w400),),
              ...
              Text("$_weightOfUser Kg", style: TextStyle(color: Colors.red, fontSize: 18, fontWeight: FontWeight.w400),),
